...
| Recover value | `Restore ecash`, `Recover mint quote`, `Recover melt quote change`, `unspent proofs`, `pending proofs`, `spent proofs` | Recovery copy can expose proofs and quotes because the user is fixing a technical state. |
